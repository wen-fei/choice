...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 专业课模块
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <table class="table table-border table-bordered table-hover">
                ...
                <tbody>
                <c:forEach var="psml" items="${PSModuleList}">
                    <tr class="text-c">
                        <td><input type="checkbox" value="" name=""></td>
                        <td>${psml.module_id}</td>
                        <td>${psml.module_name}</td>
                        <td>${psml.userInfo.name}</td>
                        <td>${psml.module_article_count}</td>
                        <td>${psml.module_read_count}</td>
                        <td>${psml.module_reply_count}</td>
