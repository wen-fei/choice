...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 公共课模块
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-border table-bordered table-hover">
                ...
                <tbody>
                <c:forEach items="${ggkModuleList}" var="ggkml" >
                    <tr class="text-c">
                    <td><input type="checkbox" value="" name=""></td>
                    <td>${ggkml.module_id}</td>
                    <td>${ggkml.module_name}</td>
                    <td>${ggkml.userInfo.name}</td>
                    <td>${ggkml.module_article_count}</td>
                    <td>${ggkml.module_read_count}</td>
                    <td>${ggkml.module_reply_count}</td>
